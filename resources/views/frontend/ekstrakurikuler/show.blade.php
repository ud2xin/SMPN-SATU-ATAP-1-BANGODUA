...
@section('content')
    <div class="py-8 sm:py-12 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 min-h-screen overflow-hidden">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">

            <!-- Back Button with Animation -->
            <div class="mb-6 sm:mb-8 animate-slideInLeft">
                <a href="{{ route('frontend.ekstrakurikuler.index') }}"
                   class="inline-flex items-center px-4 sm:px-6 py-2.5 sm:py-3 bg-white text-gray-700 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 hover:bg-gray-50 hover:-translate-x-1 text-sm sm:text-base">
            ...
            <div class="bg-white rounded-2xl sm:rounded-3xl shadow-2xl overflow-hidden animate-fadeInUp">
                ...
                <div class="p-4 sm:p-6 md:p-8 lg:p-12">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-8">
                        ...
                        <!-- Pembina Card -->
                        @if($ekskul->pembina)
                        <div class="info-card bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-xl lg:rounded-2xl p-4 sm:p-6 border-2 border-indigo-200 hover:shadow-lg transition-all duration-300 hover:scale-105 animate-slideInLeft">
                        ...
                        <!-- Jadwal Card -->
                        @if($ekskul->jadwal)
                        <div class="info-card bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl lg:rounded-2xl p-4 sm:p-6 border-2 border-purple-200 hover:shadow-lg transition-all duration-300 hover:scale-105 animate-slideInRight">
                            <div class="flex items-center">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            window.addEventListener('scroll', function() {
                if (window.innerWidth > 768) {
                    ...
                    const heroImage = document.querySelector('.relative.h-64, .relative.h-80, .relative.h-96');

                    if (heroImage) {
                        const img = heroImage.querySelector('img, svg');
                        if (img) {
