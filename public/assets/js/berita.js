...
function initPagination(currentPage, lastPage, baseUrl) {
    ...
    if (startPage > 1) {
        addPageButton(container, 1, currentPage, baseUrl);
        if (startPage > 2) {
    ...
    for (let i = startPage; i <= endPage; i++) {
        addPageButton(container, i, currentPage, baseUrl);
    }
    ...
    if (endPage < lastPage) {
        ...
        addPageButton(container, lastPage, currentPage, baseUrl);
    }
}

function addPageButton(container, page, currentPage, baseUrl) {
    if (page === currentPage) {
